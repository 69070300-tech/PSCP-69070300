...
```text
input รับชื่อ output ชื่อที่สลับเรียงจากหลังมาหน้า constraints ต้องเป็นตัวอักษรตัวเล็กทั้งไหม
```
...
```text
Step 1:รับค่า input
Step 2:ทำให้ค่าเป็นตัวเล็ก
Step 3:ทำให้เรียงจากหลังมาหน้า
Step 4:แสดงค่าที่ได้
```
...
```text
ทดลองว่าตัวใหญ่จะเป็นตัวเล็กไหม
```
...
```text
สไลด์ ที่ได้พี่จากค่ายprepro
```

เขาช่วยอะไร

```text
วิธีการเขียนคำสั่งต่างๆ
```
