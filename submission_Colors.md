...
```text
input รับค่าสีสองสี output สีที่ผสมกันได้ constraints ถ้าไม่ใช่แม่สีมาผสม ให้เป็นerror
```
...
```text
Step 1:รับค่า input
Step 2:ดูว่าตรงกับเงื่อนไขไหน
Step 3:ถ้าไม่ตรงให้เป็นerror
...
```text
เหมือนกัน ทำเหมือนกับแผนแรกแต่มีการเติมเงื่อนไขเพิ่ม
```
